...
// import { requestNotificationPermissions, setupNotificationListener } from './NotificationHandler';
...
//   // Theo dõi màn hình hiện tại bằng focus/blur
//   useEffect(() => {
...
//     return unsubscribe;
//   }, [groups, currentUserId, navigation]);
...
//           if (group && currentScreen !== 'GroupChatScreen') {
//             // Hiển thị thông báo cục bộ
//             const notificationContent = data.contentType === 'image' ? '[Hình ảnh]' : data.contentType === 'file' ? '[Tệp]' : data.content || 'Tin nhắn mới';
//             showLocalNotification({
//               title: `Tin nhắn từ ${group.name}`,
//               body: `${data.senderName || 'Unknown'}: ${notificationContent}`,
...
import { API_URL } from '../config';
import Footer from './Footer';
import { showLocalNotification, setupNotificationListener } from './NotificationHandler'; // Sửa đường dẫn nhập
